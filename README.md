...
| Кэширование | Redis 7 | Частично внедрено (refresh-токены) |
...
| `GET/POST/PUT/DELETE` | `/api/v1/topics...` | Работа с темами |
...
Для каждого из 7 справочников реализован полный CRUD (GET список, GET по ID, POST, PUT, PATCH, DELETE):
...
| CRUD справочников (все 7: roles, statuses, degrees, titles, positions) | ✅ Готово |
