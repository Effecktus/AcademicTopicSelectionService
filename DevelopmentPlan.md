...
## Актуальный статус реализации (на 2026-05-19)
...
| Этап 3: Chat/VKR/Notifications | ✅ Выполнено | 2026-05-19 | Чат по заявке, архив ВКР, уведомления (Inbox + email), аналитика и экспорт для Admin и DepartmentHead |
| Этап 4: Frontend | ✅ Выполнено | 2026-05-19 | Angular 20 SPA; все роли; итерации 0–9 реализованы; см. `FrontendDevelopmentPlan.md` |
| Этап 5: Тестирование и доработка | ✅ Выполнено | 2026-05-19 | Backend: unit + integration (Testcontainers); Frontend: unit-тесты; E2E вынесены за рамки MVP |
...
| Этап 3: Backend (функциональность) | ✅ | 2026-05-19 | Topics, два потока заявок, чат, архив ВКР, уведомления, аналитика и экспорт | — |
| Этап 4: Frontend | ✅ | 2026-05-19 | Angular 20 SPA, все роли, итерации 0–9 | — |
| Этап 5: Тестирование и доработка | ✅ | 2026-05-19 | Backend unit + integration; frontend unit; E2E вынесены за рамки MVP | — |
