...
## Актуальный статус реализации (на 2026-04-14)
...
| Этап 3: Backend функциональность (итерации 3а/3б) | ✅ Выполнено | 2026-04-14 | `SupervisorRequests` + `StudentApplications`, unit/integration тесты |
| Этап 3: Chat/VKR/Notifications | 🔄 Не начато | 2026-04-14 | Плановые итерации 4–6 |
| Этап 4: Frontend | 🔄 Не начато | 2026-04-14 | В рамках backend-ветки не реализуется |
| Этап 5: Тестирование и доработка | 🔄 Частично | 2026-04-14 | Unit/Integration backend есть, E2E нет |
