...
namespace DirectoryOfGraduates.Application.Dictionaries.AcademicDegrees;
...
/// <param name="Name">Системное имя степени.</param>
...
/// </summary>
/// <param name="Query">Строка поиска по <c>Name</c>, <c>DisplayName</c> и <c>ShortName</c> (регистронезависимый ILIKE).</param>
...
/// Для POST/PUT Name и DisplayName обязательны, ShortName опционален. Для PATCH поля со значением <c>null</c> не изменяются.
/// </summary>
/// <param name="Name">Системное имя учёной степени.</param>
